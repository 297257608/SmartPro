...
<body>
                            ...
                            <div class="ibox-content">
								<div class="row">
									<form class="form-inline">
	                                    ...
	                                    <button type="button" class="btn btn-sm btn-danger" onclick="showIcon()">查看图标</button>
                                    </form>
                                </div>
    ...
    <div class="modal inmodal" id="addTagModal" tabindex="-1" role="dialog" aria-hidden="true">
        ...
        <!-- show 图标 -->
    <div class="modal inmodal" id="showIconModal" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog">
			<div id="showIconContent" class="modal-body">
